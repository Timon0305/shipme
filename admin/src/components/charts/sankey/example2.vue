            ...
            return {
                options: {
                    grid: {
                       ...
                       color: ["#ef9a9a", "#1976d2","#e57373","#ef5350","#e53935", "#1e88e5"],
                    ...
                    series: [{
                        ...
                        nodeAlign: 'right',
                        data: data.nodes.filter(a => data.links.filter(x => x.value > 120).find(k => k.source == a.name || k.target == a.name)),
                        links: data.links.filter(x => x.value > 120),
                        lineStyle: {
                            normal: {
                                  color: 'source',
                                borderColor:`#000`,
