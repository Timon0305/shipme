...
<template>
  <div>
    ...
    <v-card img="/static/images/users/avatar-10.jpg" height="200px">
    ...
    <v-card img="/static/images/users/avatar-2.jpg" height="200px">
    ...
    <v-card img="/static/images/users/avatar-3.jpg" height="200px">
    ...
    <v-subheader>Lights out</v-subheader>
    <v-card img="/static/images/home/users/avatar-4.jpg" height="200px">
