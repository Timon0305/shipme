  ...
  <v-container style="max-width: 600px;">
    <v-timeline dense clipped>
      <v-timeline-item
        ...
        large
      >
        <span slot="icon"><i class="material-icon">home</i></span>
        <v-text-field
          v-model="input"
          hide-details
          flat
      ...
      >
        <v-layout justify-space-between>
          <v-flex xs7>
            Order confirmation email was sent to belostemas@gmail.com.
          </v-flex>
          <v-flex xs5 text-xs-right>15:25 EDT</v-flex>
        </v-layout>
      </v-timeline-item>
      ...
      >
        <v-layout justify-space-between>
          <v-flex xs7>
            Caio placed this order on Online Store (checkout #1937432132572).
          </v-flex>
          <v-flex xs5 text-xs-right>15:25 EDT</v-flex>
        </v-layout>
      </v-timeline-item>
